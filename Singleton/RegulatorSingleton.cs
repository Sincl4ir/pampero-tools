...
namespace Pampero.Tools.Singleton
{/// <summary>
 ...
 /// </summary>
    public class RegulatorSingleton<T> : MonoBehaviour where T : Component
    {
        ...
        protected virtual void InitializeSingleton()
        {
            ...
            {
                if (old.TryGetComponent<RegulatorSingleton<T>>(out var regulatorSingleton) && regulatorSingleton.InitializationTime < InitializationTime)
                {
